/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: e0ef98adb1eabbee2fd0b2870ac32bda)
// Runtime types generated with workerd@1.20251105.0 2024-04-03 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "LogTailingDO" | "ContextCoachDO" | "ConsultationSessionDO";
	}
	interface Env {
		KV: KVNamespace;
		CONSULTATION_KV: KVNamespace;
		...
		CONSULTATION_SESSION: DurableObjectNamespace<import("./src/index").ConsultationSessionDO>;
		DB: D1Database;
